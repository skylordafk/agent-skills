...
- [Launch a VS Code tab from other tools](https://code.claude.com/docs/en/vs-code#launch-a-vs-code-tab-from-other-tools)
...
- [The built-in IDE MCP server](https://code.claude.com/docs/en/vs-code#the-built-in-ide-mcp-server)
...
### [​](https://code.claude.com/docs/en/vs-code\#launch-a-vs-code-tab-from-other-tools)  Launch a VS Code tab from other tools
...
| `initialPermissionMode` | `default` | Controls approval prompts for new conversations: `default`, `plan`, `acceptEdits`, `auto`, or `bypassPermissions`. See [permission modes](https://code.claude.com/docs/en/permission-modes). |
...
### [​](https://code.claude.com/docs/en/vs-code\#the-built-in-ide-mcp-server)  The built-in IDE MCP server
