...
- [Supported channels](https://code.claude.com/docs/en/channels#supported-channels)
...
- [Enable channels for your organization](https://code.claude.com/docs/en/channels#enable-channels-for-your-organization)
- [Restrict which channel plugins can run](https://code.claude.com/docs/en/channels#restrict-which-channel-plugins-can-run)
- [Research preview](https://code.claude.com/docs/en/channels#research-preview)
- [How channels compare](https://code.claude.com/docs/en/channels#how-channels-compare)
- [Next steps](https://code.claude.com/docs/en/channels#next-steps)
...
- [Enable channels for your organization](https://code.claude.com/docs/en/channels#enterprise-controls) on Team and Enterprise
...
- **Team/Enterprise users**: your organization admin must [enable channels](https://code.claude.com/docs/en/channels#enterprise-controls) in managed settings
