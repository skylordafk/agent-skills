...
![The agentic loop: Your prompt leads to Claude gathering context, taking action, verifying results, and repeating until task complete. You can interrupt at any point.](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/images/agentic-loop.svg?w=1100&fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=448a4456db3f9d4fbf35660604f24ca5)

![Session continuity: resume continues the same session, fork creates a new branch with a new ID.](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/images/session-continuity.svg?w=1100&fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=73227d63ab94650fd98e8e6eeebfe06e)