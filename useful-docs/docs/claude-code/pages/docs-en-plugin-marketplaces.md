...
- [Pre-populate plugins for containers](https://code.claude.com/docs/en/plugin-marketplaces#pre-populate-plugins-for-containers)
...
### [​](https://code.claude.com/docs/en/plugin-marketplaces\#pre-populate-plugins-for-containers)  Pre-populate plugins for containers
...
| `plugins[0].source: Path contains ".."` | Source path contains `..` | Use paths relative to the marketplace root without `..`. See [Relative paths](https://code.claude.com/docs/en/plugin-marketplaces#relative-paths) |
